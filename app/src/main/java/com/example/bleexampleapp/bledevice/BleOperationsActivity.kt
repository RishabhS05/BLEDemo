...
class BleOperationsActivity : AppCompatActivity() {
    ...
    private lateinit var bleOprationsBinding : ActivityBleOperationsBinding
    ...
    override fun onCreate(savedInstanceState : Bundle?) {
        ...
        bleOprationsBinding = ActivityBleOperationsBinding.inflate(layoutInflater)
        setContentView(bleOprationsBinding.root)
...
//            hideKeyboard()
    ...
    private fun setupRecyclerView() {
        bleOprationsBinding.characteristicsRecyclerView.apply {
        ...
        val animator = bleOprationsBinding.characteristicsRecyclerView.itemAnimator
